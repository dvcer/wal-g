...
# Keep downloaded binlogs separate across tests and repeated runs.
WALG_MYSQL_BINLOG_DST=$(mktemp -d "/tmp/walg-binlogs-$(basename "$0" .sh).XXXXXX")
export WALG_MYSQL_BINLOG_DST
